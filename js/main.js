...
//---------------------------PÁGINA INDEX.HTML----------------------
    ...
    //---------------------------PÁGINA PREGUNTASFRECUENTES.HTML----------------------


    // VALIDACIONES PREGUNTAS Y RESPUESTAS
    //--------------------------------------------------

    //Variables generales
    let preguntas = document.querySelectorAll(".pf_suma");
    let respuestas = document.querySelectorAll("#respuesta");

    // Variables cada respuesta en particular
    ...
    // Al hacer click en la pregunta 1, la respuesta1...
    preguntas[0].addEventListener("click", function () {
        respuesta1.classList.toggle("respuesta");
        preguntas[0].classList.toggle("pf_resta");
        respuesta1.classList.toggle("respuestaNegativa");
    })

    // Al hacer click en la pregunta 2, la respuesta2...
    preguntas[1].addEventListener("click", function () {
        respuesta2.classList.toggle("respuesta");
        preguntas[1].classList.toggle("pf_resta");
        respuesta2.classList.toggle("respuestaNegativa");
    })

    // Al hacer click en la pregunta 3, la respuesta3...
    preguntas[2].addEventListener("click", function () {
        respuesta3.classList.toggle("respuesta");
        preguntas[2].classList.toggle("pf_resta");
        respuesta3.classList.toggle("respuestaNegativa");
    })

    // Al hacer click en la pregunta 4, la respuesta4...
    preguntas[3].addEventListener("click", function () {
        preguntas[3].classList.toggle("pf_resta");
        respuesta4.classList.toggle("respuestaNegativa");
    })

    // Al hacer click en la pregunta 5, la respuesta5...
    preguntas[4].addEventListener("click", function () {
        respuesta5.classList.toggle("respuesta");
        preguntas[4].classList.toggle("pf_resta");
        respuesta5.classList.toggle("respuestaNegativa");
    })
